...
export default function SpanishPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-20 text-center">
      ...
      <h1 className="font-display text-3xl sm:text-4xl font-bold mt-6 mb-3">Spanish Cuisine — Coming Soon</h1>
      <p className="text-stone text-lg mb-8 max-w-md mx-auto">
        Paella, tortilla española, gazpacho — authentic flavors, AI-adapted to your supermarket. Launching Q2 2027.
      </p>
      ...
      <div className="mt-10 bg-white rounded-lg border border-border p-6 max-w-sm mx-auto">
        <p className="text-sm font-semibold mb-3">Get notified when Spanish cuisine launches:</p>
